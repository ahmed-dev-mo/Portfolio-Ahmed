const chatbot = () => {
  ...
  $(".js-beacon").click(function(e) {
    ...
    Beacon("open");
    $(".js-beacon").blur();
    $("#c-chatbot").addClass("hide");
  });

  $(".js-chatbot").click(function(e) {
    e.preventDefault();
    Beacon("close");
    $(".js-chatbot").blur();
    $("#c-chatbot").removeClass("hide");
    $(".c-fab").addClass("hide");

    $("#c-new-content").empty();
    $(".c-chatbot__content .c-chatbot__options").removeClass("hide").addClass("active");
  });

  $(".js-chatbot-exit").click(function(e) {
    e.preventDefault();
    Beacon("close");
    $(".js-chatbot-exit").blur();
    $("#c-chatbot").addClass("hide");
  ...
  $(".c-chatbot__button").click(function(e) {
    var $this = $(this);
    e.preventDefault();
    ...
    var $answer = "#c-chatbot-q .c-chatbot__answer--" + $data;
    var $updated = "c-chatbot__answer--" + $id;
    var $location = "#c-new-content";
    var $buttons = ".c-chatbot__options";
